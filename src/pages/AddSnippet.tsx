        ...
        <div className="space-y-2 flex-1 min-w-0">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full h-64 bg-[#0B1021] border border-slate-800 rounded-xl p-4 text-slate-300 focus:border-blue-500 focus:outline-none font-mono text-sm leading-relaxed dir-ltr text-left resize-none overflow-x-auto"
            />
            <div className="absolute bottom-3 right-3 px-2 py-1 bg-slate-900/80 rounded border border-slate-800 text-[10px] text-slate-500 pointer-events-none uppercase">
              {formData.language}
            </div>
          </div>
        </div>
